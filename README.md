...
이 스킬은 **지피터스 커뮤니티**와 함께 만들었습니다.

20기 스터디를 준비하면서, "어떻게 하면 스터디장들이 더 쉽게 좋은 상세페이지를 만들 수 있을까?"를 고민했습니다. 그 고민의 결과물이 이 스킬입니다.

특히 감사드리는 분들:

- **지피터스 운영진** - 바이브코딩 스터디라는 새로운 방향을 함께 고민해주셔서
- **19기 스터디장분들** - 피드백과 아이디어를 아낌없이 나눠주셔서
- **Claude Code / OpenCode 커뮤니티** - 스킬 시스템이라는 강력한 도구를 만들어주셔서

그리고 무엇보다, **스터디장으로 지원해주시는 여러분**께 감사드립니다.

AI와 함께 성장하는 커뮤니티를 만들어가는 여정에 함께해주세요.
...
**Made with ❤️ by [GPTers](https://gpters.org) Community**
